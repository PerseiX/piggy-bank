...
describe('parsePlnToGrosze', () => {
  ...
  describe('type validation', () => {
    it('should throw TypeError for non-string input', () => {
      ...
      expect(() => parsePlnToGrosze(100 as unknown as string)).toThrow(
        'PLN amount must be provided as a string'
      );
    });
  ...
  describe('range validation', () => {
    it('should throw RangeError for amounts exceeding MAX_SAFE_INTEGER', () => {
      ...
      expect(() => parsePlnToGrosze(exceedingAmount)).toThrow(
        'PLN amount exceeds supported range'
      );
    });
...
describe('formatGroszeToPln', () => {
  ...
  describe('type validation', () => {
    it('should throw TypeError for Infinity', () => {
      ...
      expect(() => formatGroszeToPln(Infinity)).toThrow(
        'Grosze value must be a finite number'
      );
    });
    ...
    it('should throw TypeError for NaN', () => {
      ...
      expect(() => formatGroszeToPln(NaN)).toThrow(
        'Grosze value must be a finite number'
      );
    });
  });
  ...
  describe('integer validation', () => {
    it('should throw RangeError for decimal values', () => {
      ...
      expect(() => formatGroszeToPln(1.5)).toThrow(
        'Grosze value must be a safe integer'
      );
    });
  ...
  describe('range validation - negative values', () => {
    it('should throw RangeError for negative amounts', () => {
      ...
      expect(() => formatGroszeToPln(-100)).toThrow(
        'Grosze value cannot be negative'
      );
    });
