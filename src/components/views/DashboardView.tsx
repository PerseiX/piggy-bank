        ...
        <header className="mb-8">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-gray-600">Manage and track your financial wallets</p>
            </div>
            <a
              href="/wallets/new"
        ...
        <main>
          ...
          {viewModel.status === "error" && (
            <ErrorState
              ...
              message={viewModel.error || "An unexpected error occurred. Please check your connection and try again."}
            />
          )}
