    ...
    <div className="mb-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-4">
          ...
          <div className="text-2xl font-bold text-gray-900">{aggregates.invested_sum_pln} PLN</div>
        </div>

        {/* Target */}
        <div className="bg-white border border-gray-200 rounded-lg p-4">
          <div className="text-sm text-gray-600 mb-1">Target</div>
          <div className="text-2xl font-bold text-gray-900">{aggregates.target_pln} PLN</div>
        </div>
      </div>
