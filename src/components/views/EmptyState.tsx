...
export function EmptyState() {
  return (
    <div className="text-center py-12" role="status" aria-live="polite">
      ...
      <h3 className="mt-4 text-lg font-semibold text-gray-900">No wallets yet</h3>
      <p className="mt-2 text-sm text-gray-500">Get started by creating your first financial wallet.</p>
      <div className="mt-6">
        <a
          href="/wallets/new"
