...
export function parsePlnToGrosze(value: string): number {
  ...
  if (!PLN_DECIMAL_PATTERN.test(normalized)) {
    throw new RangeError("PLN amount must be a non-negative value with up to two decimal places");
  }
...
export function formatOptionalGroszeToPln(value: number | null | undefined): string | null {
...
export function formatOptionalGroszeToDual(value: number | null | undefined): CurrencyDualFormat | null {
  if (value === null || value === undefined) {
    return null;
  }
