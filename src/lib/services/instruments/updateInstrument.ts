...
export async function updateInstrument({
  ...
  if (pendingNameCheck) {
    ...
    if (duplicateCheck.error) {
      throw new UpdateInstrumentServiceError(
  ...
  return mapInstrumentRowToDto(
    updateResult.data as InstrumentRowForDto,
  )
}
