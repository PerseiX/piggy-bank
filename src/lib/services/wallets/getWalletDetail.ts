...
import type { Instrument, InstrumentDto, WalletDetailDto, WalletAggregatesDto } from "../../../types";
import { formatCurrencyFromGrosze, formatOptionalCurrencyFromGrosze } from "../currency/format";
...
interface GetWalletDetailParams {
  supabase: SupabaseClient;
  walletId: WalletRow["id"];
  ownerId: WalletRow["owner_id"];
}

const WALLET_METADATA_COLUMNS = "id,name,description,created_at,updated_at,owner_id";
