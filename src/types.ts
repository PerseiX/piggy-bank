 ...
 */
export interface CurrencyDualFormat {
  grosze: number;
  pln: string;
}
 ...
 */
export interface WalletAggregatesDto {
 ...
 */
export type WalletListItemDto = Pick<Wallet, "id" | "name" | "description" | "created_at" | "updated_at"> & {
 ...
 */
export type WalletDetailDto = Pick<Wallet, "id" | "name" | "description" | "created_at" | "updated_at"> & {
  aggregates: WalletAggregatesDto;
 ...
 */
export type WalletCreatedDto = Pick<Wallet, "id" | "name" | "description" | "created_at" | "updated_at"> & {
  aggregates: WalletAggregatesDto;
};
 ...
 */
export type WalletUpdatedDto = Pick<Wallet, "id" | "name" | "description" | "created_at" | "updated_at">;

/**
 * DTO for wallet soft-delete response (DELETE /api/wallets/:id).
 * Returns confirmation with deletion timestamp.
 */
export interface WalletDeletedDto {
  id: string;
  deleted_at: string;
}
 ...
 * Returns confirmation with deletion timestamp.
 */
export interface InstrumentDeletedDto {
  id: string;
  deleted_at: string;
}
 ...
 */
export type ValueChangeDto = Pick<InstrumentValueChange, "id" | "instrument_id" | "created_at"> & {
