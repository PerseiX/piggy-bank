...
import { ensureCorrelationId, withCorrelationIdHeader } from "../../../../lib/api/correlationId";
import {
...
export const GET: APIRoute = async ({ request, params, locals }) => {
  ...
  ) => errorResponse(status, { ...error, correlationId }, withCorrelationIdHeader(undefined, correlationId));
